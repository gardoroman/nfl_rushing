...
This app was created using Elixir, Phoenix, LiveView, PostgreSql and JavaScript.
...
To start your Phoenix server:
  ...
  * At the root directory, type `mix ecto.setup` to create the database and seed the table.
